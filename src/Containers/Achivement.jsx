    ...
    <div className='my-10'>
      <div className=' max-w-7xl mx-auto items-center gap-2 border-b p-5 '>
        <div className='text-center'>
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab aperiam veniam beatae, reiciendis ad molestiae est aliquid id qui hic dolore cupiditate itaque quaerat officia aut. Quo minus neque sed?</p>
        </div>
      ...
      <img className='h-[400px] w-full object-cover p-4' src={`https://firebasestorage.googleapis.com/v0/b/suvastutech-1e3c4.appspot.com/o/${item.data().img}?alt=media`} alt="" />
