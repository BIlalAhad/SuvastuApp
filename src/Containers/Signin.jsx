...
export default function Signin() {
    ...
    const handleLogin=(e)=>{
        ...
        Firebase.StoreEmail(email)
    }
  return (
    <>
          <>
     <section className='grid items-center justify-center w-full h-[100vh]  bg-gradient-to-b from-slate-300'>
        <div className='max-w-xl shadow-2xl bg-gray-200 p-8 grid justify-center items-center space-y-2 text-center border-t-4 border-r-4 border-orange-600'>
            <img src="logo.png" alt="" />
            <p className='text-sm font-semibold py-2'>Login To Continue</p>
            ...
            <button className='bg-blue-800 hover:bg-blue-700 text-white p-2' onClick={handleLogin}>SignIn</button>
