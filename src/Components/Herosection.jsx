...
export default function Herosection() {
  return (
    ...
    <div className='hero relative'>
        <img className='h-[50vh] sm:h-[600px] w-full object-cover brightness-75' src="hero.avif" alt="" />
        <div className='absolute top-[30%] sm:top-[40%] p-5 w-full text-center text-white space-y-4'>
            <h2 className=' font-bold text-xl  sm:text-4xl'>Suvastu App makes it easier for teams to manage projects and tasks</h2>
